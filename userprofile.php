...
?>
    ...
    <h2 class="text-purple"><u>User Profile</u></h2><hr>
...
<?php
  ...
  <div class="row">
    <div class="col-4">
    <img src="<?=$image;?>" alt="" width="300" style="  border-radius: 100%;" ><br>
    ...
    <div class="col-8">
            ...
            <div class="card shadow-lg mb-5 bg-body" style="max-width: auto;">
  <div class="card-body text-secondary" style="background-color:#F7EFFE;">
  ...
  <div class="row">
    <div class="col-6">
           <p> <h5>Name : <?=$name;?></h5></p>
           <p> <h5>City : <?=$city;?></h5></p>
           <p> <h5>Phone No. : <?=$phoneno;?></h5></p>
    </div>
           <div class="col-6">
           <p> <h5>Department : <?=$department;?></h5></p>
           <p> <h5>Batch : <?=$batch;?></h5></p>
           <p> <h5>Email : <?=$email;?></h5></p>
           </div></div></div>
    </p>
  </div>
</div>
           ...
           <p> <h4>Phone No. : <?=$phoneno;?></h4></p>

            <hr/> -->
            <a href="logout.php" class="btn btn-outline-dark btn-lg pull-right" >Logout</a>
        </div>
...
<div class="container-fluid header p-3 bg-gradient text-white text-center" style="margin-top:90px">
        <div class="row">
            <div class="col">
                <p>
                <h2>
